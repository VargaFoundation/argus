...
// pinned to impala because a .taco carries a single dialect.
(function dsbuilder(attr)
{
    var params = {};

    params["BACKEND"] = "impala";
    ...
    if (authentication == "auth-none") {
        ...
        // SASL PLAIN, with or without a password (a bare user is accepted).
    ...
    // Driver keywords the dialog does not expose (timeouts, Kerberos realm,
    // OAuth2) without needing a new connector build.
